...
public class QuerySomeURL {

	public static class QuerySomeMapper extends Mapper<Text, Text, Text, Text> {
	...
	public static class QuerySomeReducer extends Reducer<Text, Text, Text, BooleanWritable> {
	...
	public static void main(String[] args) throws Exception {
		...
		job1.setMapperClass(QuerySomeMapper.class);
		//job.setCombinerClass(IntSumReducer.class); // enable to use 'local aggregation'
		job1.setReducerClass(QuerySomeReducer.class);
