...
public class QueryAllURL {

	public static class QueryAllMapper extends Mapper<Text, Text, Text, Text> {
	...
	public static class QueryAllReducer extends Reducer<Text, Text, Text, BooleanWritable> {
	...
	public static void main(String[] args) throws Exception {
		...
		job1.setMapperClass(QueryAllMapper.class);
		//job.setCombinerClass(IntSumReducer.class); // enable to use 'local aggregation'
		job1.setReducerClass(QueryAllReducer.class);
